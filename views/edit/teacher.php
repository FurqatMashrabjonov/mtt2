                               ...
                               <input type="hidden" name="id" value="" />
                                <div class="box-body">
                                     ...
                                     <div class="form-group"> <!--  has-error -->
                                         ...
                                         <input type="text" class="form-control" id="name" name="name"  placeholder="FIO" required>
                                 ...
                                 <div class="box-footer">
                                     <button type="submit" name="hook"   value="InsertTeacher" class="btn btn-primary">Jo'natish</button>
                                 </div>
                             </form>
