                               ...
                               <input type="hidden" name="id" />
                                <div class="box-body">
                                     <div class="form-group"> <!--  has-error -->
                                         ...
                                         <input type="text" class="form-control" id="name" name="course" placeholder="Nomi..." required>
                                         <small class="help-block"></small>
                                     </div>
                                 </div>
                                 <!-- /.box-body -->
                                 <div class="box-footer">
                                     <button type="submit" name="hook" value="InsertCourse" class="btn btn-primary">Tahrirlash</button>
                                 </div>
                             </form>
                        a
