	...
	<section class="ftco-section ftco-no-pb">
			<div class="container">
              ...
              <form method="post" action="?page=add">
                               <input type="hidden" name="id" value="<?php if($user) echo $user[0]['id'] ?>" />
                                <div class="box-body">
                                     <div class="form-group"> <!--  has-error -->
                                       <img src="<?php if($user) echo $user[0]['image']; else echo 'img/nophoto.jpg'; ?>" class="name_image" alt="" />
                                     </div>
                                     <div class="form-group"> <!--  has-error -->
                                     ...
                                     <div class="form-group"> <!--  has-error -->
                                         ...
                                         <input type="text" class="form-control" id="name" name="name" value="<?php echo $teacher[0]['name']; ?>" placeholder="FIO" required>
                                         <small class="help-block"></small>
                                     </div>
                                     <div class="form-group"> <!--  has-error -->
                                         <label for="name">Fan</label>
                                         <input type="text" class="form-control" id="address" name="address" value="<?php echo $teacher[0]['subject']; ?>" placeholder="Address" required>
                                         <small class="help-block"></small>
                                     </div>
                                 ...
                                 <div class="box-footer">
                                     <button type="submit" name="hook" value="fd" class="btn btn-primary">Tahrirlash</button>
                                 </div>
                             </form>
