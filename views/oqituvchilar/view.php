            ...
            <div class="grid_8">
                <div class="block-1 top-5">
                    <div class="block-1-shadow">
                        <h2 class="clr-12 p4">Tarbiyachilar</h2>
                        <div class="pag">
                            <div class="img-pags">
                                <ul>
                                    <?php foreach ($teachers as $teacher) { ?>
                                        <li><a href="#"><span><img src="images/<?php echo $teacher['image']; ?>" alt="" width="70px" height="90px" class="img-border"> <strong class="text-2"><?php echo $teacher['name']; ?></strong></span></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
